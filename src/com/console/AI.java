...
//		System.out.println(domPlayable);
	...
	public int chooseDomino(ArrayList<Domino> domPlayable, int countTurn, boolean middleEmpire, int valueMidEmpire) {
		...
		if (this.nbKings == 1) {
			...
			if ((countTurn >= 1 || this.domino.getNumber() != 0) && (this.domPosition != null)) { // put the domino
																									// played this turn
																									// if it is playable
				Tile sq1 = this.domino.getSq1();
				Tile sq2 = this.domino.getSq2();
			...
			if ((countTurn >= 1 || this.domino2.getNumber() != 0) && (this.domPosition2 != null)) { // put the domino
																									// played this turn
																									// if it is playable
	...
	public void playDominoAI(boolean duel) {
		/*
		...
		if (this.nbKings == 1) {
			...
			this.printGameField(duel); // print the game field
		} else {
