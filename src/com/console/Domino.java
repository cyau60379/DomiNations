...
public class Domino {
	...
	public boolean isPlayable(Player player, char currentOrientation, int x1, int y1, int x2, int y2) {
		/*
		...
		Tile ds1 = domSq1;
		Tile ds2 = domSq2;
		String field1 = ds1.getField();
		String field2 = ds2.getField();
		...
		if (isChoiceInField == true) {
			...
			case 'R':
				if ((y1 == 0) || (gameField[x1][y1 - 1].getNumber() == 99)) {
					if ((x1 == 0) || (gameField[x1 - 1][y1].getNumber() == 99)) {
						if ((gameField[x1 + 1][y1].getField().compareTo(field1) == 0) 
								|| (gameField[x2][y2 + 1].getField().compareTo(field2) == 0) 
								|| (gameField[x2 + 1][y2].getField().compareTo(field2) == 0)) {
						...
						if ((gameField[x1 + 1][y1].getField().compareTo(field1) == 0)
								|| (gameField[x1 - 1][y1].getField().compareTo(field1) == 0)
								|| (gameField[x2][y2 + 1].getField().compareTo(field2) == 0)
								|| (gameField[x2 + 1][y2].getField().compareTo(field2) == 0)
								|| (gameField[x2 - 1][y2].getField().compareTo(field2) == 0)) {
							areFieldsMatching = true;
					...
					if ((x1 == 0) || (gameField[x1 - 1][y1].getNumber() == 99)) {
						if ((gameField[x1 + 1][y1].getField().compareTo(field1) == 0)
								|| (gameField[x1][y1 - 1].getField().compareTo(field1) == 0)
								|| (gameField[x2 + 1][y2].getField().compareTo(field2) == 0)) {
							areFieldsMatching = true;
						}
					} else if ((x1 == len - 1) || (gameField[x1 + 1][y1].getNumber() == 99)) {
			...
			case 'D':
				if ((x1 == 0) || (gameField[x1 - 1][y1].getNumber() == 99)) {
					if ((y1 == 0) || (gameField[x1][y1 - 1].getNumber() == 99)) {
						if ((gameField[x1][y1 + 1].getField().compareTo(field1) == 0)
								|| (gameField[x2][y2 + 1].getField().compareTo(field2) == 0)
								|| (gameField[x2 + 1][y2].getField().compareTo(field2) == 0)) {
							areFieldsMatching = true;
						}
			...
			case 'L':
				if ((y2 == 0) || (gameField[x2][y2 - 1].getNumber() == 99)) {
					if ((x2 == 0) || (gameField[x2 - 1][y2].getNumber() == 99)) {
						if ((gameField[x2 + 1][y2].getField().compareTo(field2) == 0)
								|| (gameField[x1][y1 + 1].getField().compareTo(field1) == 0)
								|| (gameField[x1 + 1][y1].getField().compareTo(field1) == 0)) {
							areFieldsMatching = true;
						}
			...
			case 'U':
				if ((x2 == 0) || (gameField[x2 - 1][y2].getNumber() == 99)) {
					if ((y2 == 0) || (gameField[x2][y2 - 1].getNumber() == 99)) {
						if ((gameField[x2][y2 + 1].getField().compareTo(field2) == 0)
								|| (gameField[x1][y1 + 1].getField().compareTo(field1) == 0)
								|| (gameField[x1 + 1][y1].getField().compareTo(field1) == 0)) {
							areFieldsMatching = true;
						}
		...
		for (int i = 0; i < player.gameField.length; i++) {
			for (int j = 0; j < player.gameField.length - 1; j++) {
				if (player.gameField[i][j].getNumber() != 99 && player.gameField[i][j + 1].getNumber() != 99) {
					if (this.isPlayable(player, 'R', i, j, i, j + 1)) {
						isImpossible = false;
					}
					if (this.isPlayable(player, 'L', i, j + 1, i, j)) {
						isImpossible = false;
					}
				}
			}
		...
		for (int j = 0; j < player.gameField.length; j++) {
			for (int i = 0; i < player.gameField.length - 1; i++) {
				if (player.gameField[i][j].getNumber() != 99 && player.gameField[i + 1][j].getNumber() != 99) {
					if (this.isPlayable(player, 'D', i, j, i + 1, j)) {
						isImpossible = false;
					}
					if (this.isPlayable(player, 'U', i + 1, j, i, j)) {
						isImpossible = false;
					}
				}
			}
